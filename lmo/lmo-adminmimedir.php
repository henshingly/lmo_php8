        ...
        if ($ftest == 1) {
            ...
            if ($t0 == '') {
                ...
                $t0 = $text[507] . ' ' . $j;
                    ...
                    <li><a target="lmoelm" href="<?php echo $addi . ($k + 1); ?>" onclick="emllmolink(this.href,'<?php echo  $aadr; ?>');return false;"><?php echo $t0; ?></a></li>
<?php
        }
    }
    if ($i == 0) {?>
...
<?php
                    ...
                    <li><a target="lmoelm" href="<?php echo $addi . '-1'; ?>" onclick="emllmolink(this.href,'<?php echo  $aadr; ?>');return false;"><strong><?php echo $text[401]; ?></strong></a></li>
<?php
    }?>
                  </ul>
<?php
