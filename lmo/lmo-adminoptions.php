...
if ($show==0) {?>
          <div class="row align-items-center">
            ...
            <div class="col-7 text-start">
              <select class="custom-select" name="xdeflang" onchange="dolmoedit()"><?php
  ...
  if (version_compare(PHP_VERSION, '5.1.0') >= 0) { ?>
          <div class="row align-items-center">
            ...
            <div class="col-7 text-start">
              <select class="custom-select" name="xtimezone" onchange="dolmoedit()"><?php
          ...
          <div class="row align-items-center">
            ...
            <div class="col-7 text-start"><input class="custom-control" type="text" name="xdirliga" size="20" maxlength="80" value="<?php echo $dirliga;?>" onChange="dolmoedit()"></div>
          </div>
          <div class="row align-items-center">
            <div class="col-5 text-end"><acronym title="<?php echo $text[240]?>"><?php echo $text[239];?></acronym></div>
            <div class="col-7 text-start"><input class="custom-control" type="text" name="xdeftime" size="5" maxlength="5" value="<?php echo $deftime;?>" onChange="dolmoedit()"></div>
          </div>
          <div class="row align-items-center">
            ...
            <div class="col-7 text-start">
              ...
              <select class="custom-control" name="xdefdateformat" onChange="dolmoedit();document.getElementsByName('xdefdateselect')[0].checked=true;"><?php
      ...
      for($y=0;$y<count($dummf);$y++){?>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-7 text-start"><input class="custom-control" type="text" name="xadr" size="25" maxlength="128" value="<?php echo $aadr;?>" onChange="dolmoedit()"></div>
          </div>
          <div class="row align-items-center">
            ...
            <div class="col-5">
              <input type="radio" name="xliga_sort_direction" onClick="dolmoedit()" value="asc"<?php if ($liga_sort_direction=="asc") echo " checked";?>> <?php echo $text[527]?><br/>
              <input type="radio" name="xliga_sort_direction" onClick="dolmoedit()" value="desc"<?php if ($liga_sort_direction=="desc") echo " checked";?>> <?php echo $text[528]?>
            </div>
          </div><?php
}elseif ($show==1) {?>
          <div class="row align-items-center">
            ...
            <div class="col-7 text-start">
              <select class="custom-select" name="xtabpkt" onChange="dolmoedit()">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-7 text-start">
              <select class="custom-select" name="xtabonres" onChange="dolmoedit()">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-1"><input type="checkbox" class="custom-control" name="xbacklink" onChange="dolmoedit()"<?php if($backlink==1){echo " checked";}?>></div>
            <div class="col-1"><input type="checkbox" class="custom-control" name="xarchivlink" onChange="dolmoedit()"<?php if($archivlink==1){echo " checked";}?>></div>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-1"><input type="checkbox" class="custom-control" name="xcalctime" onChange="dolmoedit()"<?php if($calctime==1){echo " checked";}?>></div>
            <div class="col-1"><input type="checkbox" class="custom-control" name="xeinsavehtml" onChange="dolmoedit()"<?php if($einsavehtml==1){echo " checked";}?>></div>
          ...
          <div class="row align-items-center">
            ...
            <td class="nobr"><input type="checkbox" class="custom-control" name="xeinhinrueck" onChange="dolmoedit()"<?php if($einhinrueck==1){echo " checked";}?>></td>*/?>
            <div class="col-5 text-end"><acronym title="<?php echo $text[486]?>"><?php echo $text[485];?></acronym></div>
            <div class="col-1"><input type="checkbox" class="custom-control" name="xeinspieler" onChange="dolmoedit()"<?php if($einspieler==1){echo " checked";}?>></div>
            <div class="col-1"><input type="checkbox" class="custom-control" name="xeinzustats" onChange="dolmoedit()"<?php if($einzustats==1){echo " checked";}?>></div>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-1"><input type="checkbox" class="custom-control" name="xeinspielfrei" onChange="dolmoedit()"<?php if($einspielfrei==1){echo " checked";}?>></div>
            <div class="col-1"><input type="checkbox" class="custom-control" name="xeintippspiel" onChange="dolmoedit()"<?php if($eintippspiel==1){echo " checked";}?>></div>
            <div class="col-5 text-start"><acronym title="<?php echo $text[488]?>"><?php echo $text[487];?></acronym></div>
          </div>
          <div class="row align-items-center">
            <div class="col-6"></div>
            <div class="col-1"><input type="checkbox" class="custom-control" name="xeinsprachwahl" onChange="dolmoedit()"<?php if($einsprachwahl==1){echo " checked";}?>></div>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-6 text-start">
              <input type="checkbox" class="custom-control" name="xeinzutoretab" onChange="dolmoedit()"<?php if($einzutoretab==1){echo " checked";}?>>&nbsp;&nbsp;<?php echo $text[491]?><br/>
              <input type="checkbox" class="custom-control" name="xeinzutore" onChange="dolmoedit()"<?php if($einzutore==1){echo " checked";}?>>&nbsp;&nbsp;<?php echo $text[492]?>
            </div>
          </div><?php
}?>
          <div class="row">
