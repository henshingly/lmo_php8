...
<div class="container">
  ...
  for ($i=1; $i<=$anzteams; $i++) {
    if($i!=$show_stat1){?>
	    <p><a href="<?php echo $addp.$i?>" title="<?php echo $teams[$i]?>"><?php echo HTML_smallTeamIcon($file,$teams[$i]," alt='$teams[$i]' style='vertical-align: middle;'"); ?></a></p>
	    <?php
    } else {
      //echo $teamk[$i];
      echo "<p>".HTML_smallTeamIcon($file,$teams[$i]," alt='$teams[$i]'")."</p>\n";
    }
  }?>
          </div>
        </div>
...
<?php } ?>
  ...
  for ($i=1; $i<=$anzteams; $i++) {
    if($i!=$show_stat2){?>
            <p><a href="<?php echo $addp.$show_stat1."&amp;stat2=".$i?>" title="<?php echo $teams[$i]?>"><?php echo HTML_smallTeamIcon($file,$teams[$i]," alt='$teams[$i]' style='vertical-align: middle;'"); ?></a></p>
            <?php
    } else {
      echo "<p>".HTML_smallTeamIcon($file,$teams[$i]," alt='$teams[$i]'")."</p>\n";
    }
