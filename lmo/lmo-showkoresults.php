                ...
                if ($playoffmode == 1 || $playoffmode == 2) { // Modus 2-2-1 or 2-2-1-1-1
                    if ($n == 0 || $n == 1 || $n == 4 || $n == 6) {
                        ...
                        if ($m == 1) {
                            ...
                            echo '          <td class="lmoTurnierVerlierer nobr" align="right">'; // Verlierer nicht rot einfärben
                        }*/ else {
...
<?php
                        if ($m == 2) {
                            ...
                            echo '          <td class="lmoTurnierVerlierer nobr" align="left">'; // Verlierer nicht rot einfärben
                        }*/ else {
...
<?php
                        ...
                        echo '&nbsp;' . HTML_smallTeamIcon($file, $teams[$teamb[$st - 1][$i]], ' alt=""') . '&nbsp;'; ?></td>
