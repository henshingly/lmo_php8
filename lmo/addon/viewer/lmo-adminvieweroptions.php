...
if ($_SESSION['lmouserok'] == 2) {
    ...
    isset($_POST['formular1']) ? $form1 = true : $form1 = false;  // Filled out form 1?
    isset($_POST['formular2']) ? $form2 = true : $form2 = false;  // Filled out form 2?
    isset($_POST['formular3']) ? $form3 = true : $form3 = false;  // Filled out form 3?
    if ($form1) {
            ...
            echo '<option>' . $tpl_files[$tpl] . '</option>' . chr(13);
                      ...
                      <tr>
                        ...
                        <td class="nobr" align="left">&nbsp;
                          <select class="lmo-formular-input"  name="mannschaftsnamen"  onChange="dolmoedit();">
...
?>
      <table class="lmoMiddle" cellspacing="0" cellpadding="0" border="0" width="600">
        ...
        foreach($ligadatei as $liga) { ?>
                          <input type="checkbox" name="<?php echo 'c' . $z;?>" value="<?php echo 'c' . $z;?>"> <?php echo $liga['liga_name'] . '<br>';?>
<?php
            echo chr(13);
            $z++;
        }
?>
                      ...
                      <tr>
                        <td align="left">
                          <script type="text/javascript">
                            ...
                            document.writeln ('<input type=button value="<?php echo $text['viewer'][45];?>" onClick="switchAll(this)"\>');</script>
                        </td>
                      </tr>
                      <tr>
    ...
    if (!$form3 && $form2) {   // <!-- Jetzt kommt die Auswahl der Mannschaften  -->
?>
      <table class="lmoMiddle" cellspacing="0" cellpadding="0" border="0" width="600">
        <tr>
          <th align="center"><h1><?php echo $text['viewer'][21];?> </h1></th>
