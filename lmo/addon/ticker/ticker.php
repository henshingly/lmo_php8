...
?>
          ...
          <script type="text/javascript" src="<?php echo URL_TO_LMO; ?>/js/jquery.min.js"></script>
          <script type="text/javascript" src="<?php echo URL_TO_LMO;?>/js/jquery.marquee.min.js"></script>
