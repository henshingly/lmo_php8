...
<div class="container">
  <div class="row pb-2">
    <div class="col"><h1><?php echo $text['tipp'][33] ?></h1></div>
  </div>
  <div class="row pb-2">
  ...
  if ($show==0) {?>
          <div class="row pb-2">
            ...
            <div class="col-7 text-start">
              <select class="custom-select" name="xtippmodus" onChange="moduschange()">
          ...
          <div class="row pb-2">
            ...
            <div class="col-7 text-start"><input class="form-control" type="text" name="xdirtipp" size="20" maxlength="80" value="<?php echo $tipp_dirtipp; ?>" onChange="dolmoedit()"></div>
          </div><?php  }elseif ($show==2) {?>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][34]; ?></div>
            <div class="col-7 text-start"><input class="form-control" type="text" name="xrergebnis" size="5" maxlength="5" value="<?php echo $tipp_rergebnis; ?>" onChange="dolmoedit()"<?php if($tipp_tippmodus==0){echo " disabled";} ?>>&nbsp;<?php echo $text['tipp'][38]; ?></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][35]; ?></div>
            <div class="col-7 text-start"><input class="form-control" type="text" name="xrtendenzdiff" size="5" maxlength="5" value="<?php echo $tipp_rtendenzdiff; ?>" onChange="dolmoedit()"<?php if($tipp_tippmodus==0){echo " disabled";} ?>>&nbsp;<?php echo $text['tipp'][38]; ?></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][36]; ?></div>
            <div class="col-7 text-start"><input class="form-control" type="text" name="xrtendenz" size="5" maxlength="5" value="<?php echo $tipp_rtendenz; ?>" onChange="dolmoedit()"<?php if($tipp_tippmodus==0){echo " disabled";} ?>>&nbsp;<?php echo $text['tipp'][38]; ?></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][37]; ?></div>
            <div class="col-7 text-start"><input class="form-control" type="text" name="xrtor" size="5" maxlength="5" value="<?php echo $tipp_rtor; ?>" onChange="dolmoedit()"<?php if($tipp_tippmodus==0){echo " disabled";} ?>>&nbsp;<?php echo $text['tipp'][38]; ?></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][189]; ?></div>
            <div class="col-7 text-start">
              <select class="custom-select" name="xrtendenztor" onChange="dolmoedit()"<?php if($tipp_tippmodus==0){echo " disabled";}?>>
          ...
          <div class="row pb-2">
            ...
            <div class="col-7 text-start">
              <select class="custom-select" name="xrtendenzremis" onChange="dolmoedit()"<?php if($tipp_tippmodus==0){echo " disabled";}?>>
          ...
          <div class="row pb-2">
            ...
            <div class="col-7 text-start"><input class="form-control" type="text" name="xrremis" size="5" maxlength="5" value="<?php echo $tipp_rremis; ?>" onChange="dolmoedit()">&nbsp;<?php echo $text['tipp'][38]; ?></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][152]; ?></div>
            <div class="col-7 text-start"><input type="checkbox" class="form-check-input" name="xentscheidungnv" onClick="dolmoedit()"<?php if($tipp_entscheidungnv==1){echo " checked";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][153]; ?></div>
            <div class="col-7 text-start"><input type="checkbox" class="form-check-input" name="xentscheidungie" onClick="dolmoedit()"<?php if($tipp_entscheidungie==1){echo " checked";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][196]; ?></div>
            <div class="col-7 text-start">
              <select class="custom-select" name="xgtpunkte" onChange="dolmoedit()">
          ...
          <div class="row pb-2">
            ...
            <div class="col-7 text-start"><input type="checkbox" class="form-check-input" name="xtippeinsicht" onClick="dolmoedit()"<?php if($tipp_tippeinsicht==1){echo " checked";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][172]; ?></div>
            <div class="col-7 text-start"><input type="checkbox" class="form-check-input" name="xtipptabelle1" onClick="dolmoedit()"<?php if($tipp_tipptabelle1==1){echo " checked";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text[133]; ?></div>
            <div class="col-7 text-start"><input type="checkbox" class="form-check-input" name="xtippfieber" onClick="dolmoedit()"<?php if($tipp_tippfieber==1){echo " checked";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][56]; ?></div>
            <div class="col-7 text-start"><input type="checkbox" class="form-check-input" name="xgesamt" onClick="dolmoedit()"<?php if($tipp_gesamt==1){echo " checked";}?>></select>
            </div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][187]; ?></div>
            <div class="col-7 text-start"><input type="checkbox" class="form-check-input" name="xregeln" onClick="regelnchange()"<?php if($tipp_regeln==1){echo " checked";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][186]; ?></div>
            <div class="col-7 text-start"><input class="form-control" type="text" name="xregelnlink" size="30" maxlength="256" value="<?php echo $tipp_regelnlink; ?>" onChange="dolmoedit()"<?php if($tipp_regeln==0){echo " disabled";}?>></div>
          </div>
          <div class="row pb-2">
          ...
          <div class="row pb-2">
            ...
            <div class="col-7 text-start"><input class="form-control" type="text" name="xtippbis" size="5" maxlength="5" value="<?php echo $tipp_tippBis; ?>" onChange="dolmoedit()"><?php echo " ".$text['tipp'][88]; ?></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][248]; ?></div>
            <div class="col-7 text-start">
              <select class="custom-select" name="xtippohne" onChange="dolmoedit()">
          ...
          <div class="row pb-2">
            ...
            <div class="col-7 text-start">
              <select class="custom-select" name="xtipperteam" onChange="dolmoedit()">
          ...
          <div class="row pb-2">
            ...
            <div class="col-7 text-start">
              <select class="custom-select" name="ximvorraus" onChange="dolmoedit()">
          ...
          <div class="row pb-2">
            ...
            <div class="col-7 text-start"><input type="checkbox" class="form-check-input" name="xjokertipp" onClick="jokerchange()"<?php if($tipp_jokertipp==1){echo " checked";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][291]; ?></div>
            <div class="col-7 text-start">
              <select class="custom-select" name="xjokertippmulti" onChange="dolmoedit()"<?php if($tipp_jokertipp==0){echo " disabled";}?>>
          ...
          <div class="row pb-2">
            ...
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xadresse" onClick="dolmoedit()"<?php if($tipp_adresse==1){echo " checked";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][286]; ?></div>
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xrealname" onClick="dolmoedit()"<?php if($tipp_realname==1){echo " checked";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][299]; ?></div>
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xfreischaltcode" onClick="dolmoedit()"<?php if($tipp_freischaltcode==1){echo " checked";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][146]; ?></div>
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xfreischaltung" onClick="dolmoedit()"<?php if($tipp_freischaltung==1){echo " checked";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][293]; ?></div>
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xmailbeianmeldung" onClick="dolmoedit()"<?php if($tipp_mailbeianmeldung==1){echo " checked";}?>></div>
          </div><?php  }elseif ($show==6) {?>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][245]." ".$text['tipp'][294]; ?></div>
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xpfeiltipp" onClick="dolmoedit()"<?php if($tipp_pfeiltipp==1){echo " checked";}?><?php if($tipp_tippmodus==0){echo " disabled";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][188]." ".$text['tipp'][212]." ".$text['tipp'][294]; ?></div>
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xshowtendenzabs" value="1" <?php if($tipp_showtendenzabs==1){echo "checked";} ?> onClick="dolmoedit()"></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][188]." ".$text['tipp'][211]." ".$text['tipp'][294]; ?></div>
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xshowtendenzpro" value="1" <?php if($tipp_showtendenzpro==1){echo "checked";} ?> onClick="dolmoedit()"></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][213]." ".$text['tipp'][294]; ?></div>
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xshowdurchschntipp" value="1" <?php if($tipp_showdurchschntipp==1){echo "checked";} ?> onClick="dolmoedit()"<?php if($tipp_tippmodus==0){echo " disabled";} ?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][259]; ?></div>
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xsttipp" onClick="viewerchange();"<?php if($tipp_sttipp==1){echo " checked";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][253]; ?></div>
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xviewertipp" onClick="viewerchange();"<?php if($tipp_viewertipp==1){echo " checked";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][254]; ?></div>
            <div class="col-2 text-start"><input class="form-control" type="text" name="xviewertage" size="2" maxlength="2" value="<?php echo $tipp_viewertage; ?>" onChange="dolmoedit()"<?php if($tipp_viewertipp==0){echo " disabled";} ?>>&nbsp;<?php echo $text['tipp'][171]; ?></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][161]; ?></div>
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xakteinsicht" onClick="dolmoedit()"<?php if($tipp_akteinsicht==1){echo " checked";}?>></div>
          </div><?php  }elseif ($show==7) {?>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][160]; ?></div>
            <div class="col-2 text-start">
              <select class="custom-select" name="xeinsichterst" onChange="dolmoedit()">
          ...
          <div class="row pb-2">
            ...
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xtipptabelle" onClick="dolmoedit()"<?php if($tipp_tipptabelle==1){echo " checked";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][260]; ?></div>
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xwertverein" onClick="dolmoedit()"<?php if($tipp_wertverein==1){echo " checked";}?>></div>
          </div><?php  }elseif ($show==9) {?>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][302]; ?></div>
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xnurgesamt" onClick="dolmoedit()"<?php if($tipp_nurgesamt==1){echo " checked";}?><?php if($tipp_gesamt==0){echo " disabled";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][204]; ?></div>
          ...
          <div class="row pb-2">
            ...
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xshowzus" onClick="dolmoedit()"<?php if($tipp_showzus==1){echo " checked";}?>><?php echo $text['tipp'][282]; ?></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][272]; ?></div>
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xshowstsiege" onClick="dolmoedit()"<?php if($tipp_showstsiege==1){echo " checked";}?>></div>
          </div><?php  }elseif ($show==10) {?>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][275]." 1"; ?></div>
            <div class="col-2 text-start">
              <select class="custom-select" name="xkrit1" onChange="dolmoedit()">
          ...
          <div class="row pb-2">
            ...
            <div class="col-2 text-start">
              <select class="custom-select" name="xkrit2" onChange="dolmoedit()">
          ...
          <div class="row pb-2">
            ...
            <div class="col-2 text-start">
              <select class="custom-select" name="xkrit3" onChange="dolmoedit()">
          ...
          <div class="row pb-2">
            ...
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xaktauswert" onClick="dolmoedit()"<?php if($tipp_aktauswert==1){echo " checked";}?>></div>
          </div>
          <div class="row pb-2">
            <div class="col-4 text-end"><?php echo $text['tipp'][180]; ?></div>
            <div class="col-2 text-start"><input type="checkbox" class="form-check-input" name="xaktauswertges" onClick="dolmoedit()"<?php if($tipp_aktauswertges==1){echo " checked";}?>></div>
