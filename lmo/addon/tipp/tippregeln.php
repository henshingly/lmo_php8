...
$lang=array(
    ...
    "Nederlands"=>array(
        ...
        "HEADER"=>"Wedregels",
        "JAVA"=>"Sluit venster",
        "ABS_1"=>"Instructies voor het wedden",
        "ABS_1_text1"=>"Na het registreren voor het voorspellingsspel, heeft de gokker de optie om zich voor één <strong>of</strong> meerdere voorspellingsspellen te registreren.",
        "ABS_2"=>"Procedure voor het inschrijven en spelen van individuele competities",
        "ABS_2_text1"=>"Aanmelden en beheren",
        "ABS_2_text2"=>'Klik op "<strong>aanmelden</strong>" in het inloggedeelte.',
        "ABS_2_text3"=>"Voer alle inloggegevens in en selecteer op welke competitie je je wilt abonneren.<br /><strong>Opmerking</strong>: Je kunt je op elk moment na je eerste registratie onder je gebruikersnaam inschrijven voor andere competities!",
        "ABS_2_text4"=>"Na het registreren ben je ingelogd of kun je op elk moment inloggen met je nickname.",
        "ABS_2_text5"=>"In het gebruikersgedeelte van de voorspellingsronde kun je:",
        "ABS_2_text6"=>"Tik op een geabonneerde <strong>league</strong>",
        "ABS_2_text7"=>"Scores bekijken",
        "ABS_2_text8"=>"Je gegevens wijzigen",
        "ABS_2_text9"=>"andere of nieuwe competities toevoegen aan je wedbriefje",
        "ABS_2_text10"=>"Wachtwoord wijzigen",
        "ABS_2_text11"=>"<strong>Tip account verwijderen</strong> (<strong>Attentie</strong>: Alle geabonneerde voorspellingsrondes van jouw nickname worden verwijderd!)",
        "ABS_2_text12"=>"Uitloggen uit het voorspellingsspel",
        "ABS_2_text13"=>"Competitietip",
        "ABS_2_text14"=>"Nadat je bent ingelogd, selecteer je een competitie waarop je wilt wedden in het gedeelte voor weddenschappen.",
        "ABS_2_text15"=>"In het voorspellingsgebied kun je nu weddenschappen plaatsen voor de afzonderlijke wedstrijddagen.",
        "ABS_2_text16"=>"Klik na het invoeren van de tips van <strong>een wedstrijddag</strong> op <strong>Tips opslaan</strong>",
        "ABS_2_text17"=>"Je kunt nu overschakelen naar een andere wedstrijddag en verdere tips geven.",
        "ABS_2_text18"=>"Het is ook mogelijk om per wedstrijddag een <strong>joker</strong> in te stellen. De gewonnen punten voor deze wedstrijddag worden dan vermenigvuldigd met een bepaalde factor.",
        "ABS_2_text19"=>"Opmerkingen over het indienen van tips",
        "ABS_2_text20"=>"De wedtijd loopt voor elke wedstrijd afzonderlijk af.",
        "ABS_2_text21"=>"Het einde van de inzetperiode is",
        "ABS_2_text21_1"=>"minuten voor de aftrap.",
        "ABS_2_text22"=>"Als <strong>zonder</strong> ons medeweten individuele wedstrijden worden vervroegd, bieden we daarvoor onze excuses aan. We proberen echter altijd om gewijzigde aanvangstijden <strong>vóór</strong> een wedstrijddag bij te werken.",
        "ABS_3"=>"Wedstrijdranglijst en competitieranglijst",
        "ABS_3_text1"=>"De wedstrijdscore (puntenverdeling)",
        "ABS_3_text2"=>"Resultaat correct: <strong>",
        "ABS_3_text2_1"=>"Punten</strong>",
        "ABS_3_text3"=>"alleen tendens en doelsaldo correct: <strong>",
        "ABS_3_text4"=>"alleen tendens correct: <strong>",
        "ABS_3_text5"=>"Slechts één aantal doelpunten correct: <strong>",
        "ABS_3_text6"=>"Joker vermenigvuldiger:",
        "ABS_3_text7"=>"Er is ook de mogelijkheid om een <strong>joker</strong> per wedstrijddag in te stellen. De gewonnen punten voor deze wedstrijddag worden dan dubbel geteld.",
        "ABS_3_text8"=>"De competitie en stand op de wedstrijddag",
        "ABS_3_text9"=>"Je kunt de algemene competitiestand zien door een competitie te selecteren in het overzicht van de voorspellingsrondes onder het item: <strong>Scores bekijken</strong>.",
        "ABS_3_text10"=>"Je kunt ook naar de algemene competitiestand gaan door naar <strong>Colitiestand</strong> te gaan in het voorspellingsgebied.",
        "ABS_3_text11"=>"Je kunt de gescoorde punten in je <strong>individuele</strong> wedstrijden bekijken door een complete wedstrijddag op te roepen in het <strong>voorspellingsgebied</strong> van een competitie.",
        "ABS_3_text12"=>"De <strong>algemene winnaar</strong> is de speler die de meeste punten op zijn of haar account heeft na een seizoen spelen.",
        "ABS_3_text13"=>"Daarnaast kunnen de tips van de andere spelers worden bekeken onder <strong>Tipweergave</strong>.",
        "ABS_3_text14"=>"De <strong>tip-tabel</strong> is een extra weergave, d.w.z. een tabel die wordt gegenereerd op basis van de tips die je hebt opgegeven.",
        "ABS_3_text15"=>"Opmerkingen over de timing van de tip-evaluatie",
        "ABS_3_text16"=>"De technische evaluatie van de wedstrijdtips vindt meestal plaats na elke voltooide wedstrijddag.",
        "ABS_3_text17"=>"Houd er rekening mee dat de fooi-evaluatie om organisatorische redenen <strong>1 tot 2 dagen</strong> kan worden uitgesteld.",
        "ABS_4"=>"Disclaimer",
        "ABS_4_text1"=>"De Organisator kan op geen enkele wijze aansprakelijk worden gesteld voor eventuele transmissiefouten of andere technische problemen.",
        "ABS_4_text2"=>"Door je te registreren voor het spel accepteer je de algemene voorwaarden. Dit spel is puur voor amusementsdoeleinden. Iedereen die hackt, vervalst of zich meerdere keren onder verschillende namen registreert, wordt gestraft met een spelverbod.",
        "ABS_4_text3"=>"Het juridische proces is uitgesloten.",
    ),
    "Francais"=>array(
        "LANG"=>"FR",
