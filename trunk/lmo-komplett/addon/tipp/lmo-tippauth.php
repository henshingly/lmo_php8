  ...
  <tr>
    <td class="lmost5" colspan="3" align="left">
      ...
      if(isset($dummy) && isset($ftest2)){
        ...
        <li class="lmoadminli"><a href="<? echo $addw.$dirliga.$dummy[$u].".l98"; ?>"><? echo $ftest2[$u];if(file_exists($auswertfile)){echo "<br><small>".$text['tipp'][83].": ".date("d.m.Y H:i",filectime($auswertfile))."</small>";}echo "</a>"; ?></li><?
          }
        }
      }
      if($tipp_gesamt==1 && $u>2){
        $auswertfile=PATH_TO_ADDONDIR."/tipp/".$tipp_dirtipp."auswert/gesamt.aus";?>
        <li class="lmoadminli"><a href="<? echo $addw."&amp;all=1" ?>"><strong><? echo $text['tipp'][25];if(file_exists($auswertfile)){echo "<br><small>".$text['tipp'][83].": ".date("d.m.Y H:i",filectime($auswertfile))."</small>";}?> </strong></a></li><?
      }
      $auswertfile="";?>
      </ul>
    </td>
