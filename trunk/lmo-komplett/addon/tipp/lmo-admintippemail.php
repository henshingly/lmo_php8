...
if(!isset($betreff) || $betreff==""){$betreff=$text['tipp'][0];}
if(!isset($betreff1)){$betreff1="";}
if(!isset($tipp_textreminder1)){$tipp_textreminder1="";}
...
<table class="lmosta" cellspacing="0" cellpadding="0" border="0">
  <tr>
    <td class="lmost1" align="center"><?PHP echo $text['tipp'][165] ?></td>
  </tr>
  ...
  <tr>
    ...
    <td class="lmost5" colspan="3"><acronym><input type="radio" name="emailart" value="0" id="0" <?PHP if($emailart==0){echo "checked";} ?> onClick="changetextarea(0)"><label for="0"><?PHP echo $text['tipp'][166]; ?></label></acronym></td>
  </tr>
  <tr>
    <td class="lmost5" width="20">&nbsp;</td>
    <td class="lmost5"><acronym><input type="radio" name="emailart" value="2" id="2" <?PHP if($emailart==2){echo "checked";} ?> onClick="changetextarea(2)"><label for="2"><?PHP echo $text['tipp'][168]; ?></label></acronym></td>
    <td class="lmost5" colspan="2">
    <select name="adressat" onChange="emailart[1].checked=true;changetextarea(2);">
      <?PHP
        echo "<option value=\"\" "; echo ">".$text['tipp'][51]."</option>";
  ...
  <tr>
    <td class="lmost5" width="20">&nbsp;</td>
    <td class="lmost5" valign="top"><acronym><input type="radio" name="emailart" value="1" id="1" <?PHP if($emailart==1){echo "checked";} ?> onClick="changetextarea(1)"><label for="1"><?PHP echo $text['tipp'][167]; ?></label></acronym></td>
    <td class="lmost5" colspan="2"><table cellspacing="0" cellpadding="0" border="0">
      <?PHP
        $ftype=".l98";$iptype="reminder";require(PATH_TO_ADDONDIR."/tipp/lmo-tippnewdir.php");
        if($i>0){
      ?>
              <tr><td class="lmost5" colspan="2">
                ...
                <label for="-1"><?PHP echo "<b>".$text['tipp'][263]."</b>"; ?></label></td>
                </tr>
      <?PHP } ?>
    </table>
    <br><?PHP echo $text['tipp'][170]; if(!isset($tage)){$tage=4;}?>
    <input class="lmoadminein" type="text" name="tage" size="2" maxlength="2" value="<?PHP echo $tage; ?>" onFocus="emailart[2].checked=true;changetextarea(1);"><?PHP echo " ".$text['tipp'][171];?>
    <br>
    <?PHP echo $text['tipp'][164]; //Tipper
    $start1=1;
  ...
  <tr>
    ...
    <?PHP
    echo $text['tipp'][264]."<br>".$text['tipp'][265];
    ...
    <br>
    <textarea id="message" name="message" rows="10" cols="60"><?PHP if($emailart==1){echo $tipp_textreminder1;}elseif($message!=""){echo $message;}else{echo "Hallo Tipper,";} ?></textarea>
  </td></tr>
  <tr>
    <td class="lmost5" colspan="4" align="right"><input class="lmoadminbut" type="submit" name="best" value="<?PHP echo $text['tipp'][169]; ?>">
    </td>
  </tr>
  </form>
  <tr>
    <td class="lmost4" width="20">&nbsp;</td>
    <td class="lmost4" colspan="1" valign="top" align="right"><?PHP echo $text['tipp'][178]; ?></td>
    <td class="lmost4" colspan="2"><?PHP echo $text['tipp'][179]; ?></td>
    </td>
  </tr>
  </table></td>
  <tr>
...
<?PHP 
  ...
  echo "<td class=\"lmost1\" align=\"center\">".$text['tipp'][165]."</td>";
