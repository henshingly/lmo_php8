  ...
  <tr>
    <td>
      <table width="100%" cellspacing="0" cellpadding="0" border="0">
        <tr>
          <td class="lmost1" align="center"><?=$text['tipp'][63]?></td><?
if($_SESSION['lmouserok']==2){?>
          <td class="lmost2" align="center"><a href='<?=$_SERVER['PHP_SELF']."?action=admin&amp;todo=tippemail"?>' onClick="return chklmolink(this.href);" title="<?=$text['tipp'][165]?>"><?=$text['tipp'][165]?></a></td>
