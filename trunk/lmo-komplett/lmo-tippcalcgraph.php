...
if(!file_exists($auswertfile))
  ...
  if($kurvenmodus>1 && $showstsiege==1 && ($krit1==6 || $krit2==6 || $krit3==6)){ // Spieltagssieger ermitteln
    ...
    for($i=0;$i<$anzst;$i++){
      ...
      for($a=0;$a<$anztipper;$a++){
        ...
        for($k=1;$k<=3;$k++){
          if($k==1){$krit=$krit1;}elseif($k==2){$krit=$krit2;}elseif($k==3){$krit=$krit3;}
          if($krit==-1){$tt.=50000000;}
          elseif($krit==0){$tt.=(50000000-$spielegetippt[$a][$i]);}
          elseif($krit==1){$tt.=(50000000+$spielegetippt[$a][$i]);}
          elseif($showzus==1){
            if($krit==2){$tt.=(50000000+$punkte1[$a][$i]);}
            elseif($krit==3){$tt.=(50000000+$punkte2[$a][$i]);}
            elseif($krit==4){$tt.=(50000000+$punkte3[$a][$i]);}
            elseif($krit==5){$tt.=(50000000+$punkte6[$a][$i]);}
            }
          }
        $tt.=(50000000+$a);
        array_push($tab[$i],$tt);
      ...
      for($a=0;$a<$anztipper;$a++){
        if($kurvenmodus<4){
          ...
          for($k=1;$k<=3;$k++){
            if($k==1){$krit=$krit1;}elseif($k==2){$krit=$krit2;}elseif($k==3){$krit=$krit3;}
            if($krit==-1){$tt.=50000000;}
            elseif($krit==0){$tt.=(50000000-$spielegetippt[$a][$jyz]);}
            elseif($krit==1){$tt.=(50000000+$spielegetippt[$a][$jyz]);}
            elseif($krit==6){if($showstsiege==1){$tt.=(50000000+$stsiege[$a][$jyz]);}}
            elseif($showzus==1){
              if($krit==2){$tt.=(50000000+$punkte1[$a][$jyz]);}
              elseif($krit==3){$tt.=(50000000+$punkte2[$a][$jyz]);}
              elseif($krit==4){$tt.=(50000000+$punkte3[$a][$jyz]);}
              elseif($krit==5){$tt.=(50000000+$punkte6[$a][$jyz]);}
              }
            }
          $tt.=(50000000+$a);
        ...
        if($kurvenmodus>2){
          if($jyz>0){
    	    ...
    	    if($kurvenmodus>1 && $showstsiege==1 && ($krit1==6 || $krit2==6 || $krit3==6)){
          ...
          for($k=1;$k<=3;$k++){
            if($k==1){$krit=$krit1;}elseif($k==2){$krit=$krit2;}elseif($k==3){$krit=$krit3;}
            if($krit==-1){$tt.=50000000;}
            elseif($krit==0){$tt.=(50000000-$spielegetipptgesamt[$a][$jyz]);}
            elseif($krit==1){$tt.=(50000000+$spielegetipptgesamt[$a][$jyz]);}
            elseif($krit==6){if($showstsiege==1){$tt.=(50000000+$stsiegegesamt[$a][$jyz]);}}
            elseif($showzus==1){
              if($krit==2){$tt.=(50000000+$punkte1gesamt[$a][$jyz]);}
              elseif($krit==3){$tt.=(50000000+$punkte2gesamt[$a][$jyz]);}
              elseif($krit==4){$tt.=(50000000+$punkte3gesamt[$a][$jyz]);}
              elseif($krit==5){$tt.=(50000000+$punkte6gesamt[$a][$jyz]);}
              }
            }
          $tt.=(50000000+$a);
