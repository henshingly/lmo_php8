...
for($i=1;$i<=count($tippdaten);$i++){
  ...
  if($lmtype==0){
    if(($op2=="Round") && ($op8=="GA")){
      ...
      if($goaltippa[$op3][$op4]==""){$goaltippa[$op3][$op4]=-1;}
      if($goaltippa[$op3][$op4]=="-1"){$goaltippa[$op3][$op4]="_";}
      }
    if(($op2=="Round") && ($op8=="GB")){
      $goaltippb[$op3][$op4]=$dum[2];
      if($goaltippb[$op3][$op4]==""){$goaltippb[$op3][$op4]=-1;}
      if($goaltippb[$op3][$op4]=="-1"){$goaltippb[$op3][$op4]="_";}
      }
    }
  else{
    if(($op2=="Round") && ($op8=="GA")){
      $goaltippa[$op3][$op6][$op7]=$dum[2];
      if($goaltippa[$op3][$op6][$op7]==""){$goaltippa[$op3][$op6][$op7]=-1;}
      if($goaltippa[$op3][$op6][$op7]=="-1"){$goaltippa[$op3][$op6][$op7]="_";}
      }
    if(($op2=="Round") && ($op8=="GB")){
      $goaltippb[$op3][$op6][$op7]=$dum[2];
      if($goaltippb[$op3][$op6][$op7]==""){$goaltippb[$op3][$op6][$op7]=-1;}
      if($goaltippb[$op3][$op6][$op7]=="-1"){$goaltippb[$op3][$op6][$op7]="_";}
      }
    }
  }
  clearstatcache();
