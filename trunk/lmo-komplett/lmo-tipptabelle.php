...
<?PHP
    ...
    if($spielegetippt[$i]!=0){
      if($tippmodus==1){$quote=number_format($tipppunktegesamt[$i]/$spielegetippt[$i],2,".",",");}
      if($tippmodus==0){$quote=number_format($tipppunktegesamt[$i]/$spielegetippt[$i]*100,2,".",",");}
      }
    echo "<td class=\"".$dumm1."\" width=\"2\">&nbsp;</td><td class=\"".$dumm1."\" align=\"right\">";
