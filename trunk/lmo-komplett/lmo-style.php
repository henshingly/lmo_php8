...
.lmost0,.lmost0 a {  background: $tabbback; color: $tabccolo; font-family: $tabbfont; }
  ...
  .lmost0 a:hover,.lmost0 a:active { background: $tabbcolo; color: $tabbback; text-decoration: none; border:0;}
...
.lmost0a,.lmost0a a { background: $tabbback; color: $tabbcolo; font-family: $tabbfont; }
  ...
  .lmost0a a:hover,.lmost0a a:active { background: $tabbcolo; color: $tabbback; text-decoration: none; border:0;}
...
.lmost4,.lmost4 a { background: $tabcgrey; color: $tabccolo; font-family: $tabcfont; }
  ...
  .lmost4 a:hover,.lmost4 a:active { text-decoration: underline; border:0;}
...
.lmost5,.lmost5 a { background: $tabcback; color: $tabccolo; font-family: $tabcfont; }
  ...
  .lmost5 a:hover,.lmost5 a:active {  background: $tabcback; color: $tabclin2; text-decoration: underline; border:0;}
