...
$configfile=$prefix."config_lmo_viewer.php";       // Hier jeweils bei UNVERŽNDERTEN DATEIEN das
$anzeigenfile=$prefix."lmo_viewer_anzeigen.php";	   // 'prefix.' ENTFERNEN. Selbstredend muss die
$kopffile=$prefix."lmo_viewer_kopf.php";			   // enstprechende Datei dann auch mit dem
$fussfile=$prefix."lmo_viewer_fuss.php";		   // prefix benannt werden. im o.g. Beispiel also:
$designfile=$prefix."lmo-style.css";			   // 'pa1-lmo-style.css'
$datendatei=$prefix."lmo_viewer_dat.inc.php";
