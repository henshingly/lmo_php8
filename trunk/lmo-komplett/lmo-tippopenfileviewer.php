  ...
  if(substr($file,-4)==".l98"){
    ...
    while (!feof($datei)) {
      ...
      elseif((strpos($zeile,"=")!=false) && (substr($zeile,0,1)!=";")){
        ...
        if($sekt=="Options"){
          if($schl=="Name"){$titel0=stripslashes($wert);}
          if($schl=="Type"){$lmtype0=stripslashes($wert);}
          if($schl=="Teams"){$anzteams=$wert;}
          if($lmtype0==0){
            if($schl=="HideDraw"){$hidr0=$wert;}
            }
          if($schl=="DatS"){$dats0=$wert;}
          if($schl=="DatM"){$datm0=$wert;}
      ...
      if($op2=="Round"){
        ...
        if($dum[1]=="D1"){
          ...
          if($dum[2]!=""){
            ...
            if($tippohne==1 && $deftime>0){$dummy1=$dummy1+substr($deftime,0,2)*60*60+substr($deftime,3,2)*60;}
            if($dummy1>-1){$dum[2]=strftime("%d.%m.%Y",$dummy1);}else{$dum[2]="";}
            }
          $datum10=$dum[2];
          }
        elseif($dum[1]=="D2"){
          ...
          if($dum[2]!=""){
            ...
            if($tippohne==1 && $deftime>0){$dummy2=$dummy2+substr($deftime,0,2)*60*60+substr($deftime,3,2)*60;}
            if($dummy2>-1){$dum[2]=strftime("%d.%m.%Y",$dummy2);}else{$dum[2]="";}
            }
          $datum20=$dum[2];
          }
        elseif($dum[1]=="MO" && $lmtype0!=0){$modus0=$dum[2];}
        elseif($op8=="TA"){$teama0=$dum[2];}
        elseif($op8=="TB"){$teamb0=$dum[2];}
        elseif($op8=="GA"){$goala0=$dum[2];}
        elseif($op8=="GB"){$goalb0=$dum[2];}
        elseif($op8=="SP"){$mspez0=$dum[2];}
        elseif($op8=="ET" && $lmtype0==0 && $dum[2]==3){$msieg0=3;}
        elseif($op8=="NT"){$mnote0=addslashes($dum[2]);}
        elseif($op8=="TI"){$mtipp0=$dum[2];}
        elseif($op8=="AT" && $teama0>0){
          $btip=false;
          if($dum[2]>0){if($now<=$dum[2] && $then>$dum[2]){$btip=true;}}
          elseif($dummy1>0){if($now<=$dummy1 && $then>$dummy1){$btip=true;}}
          elseif($dummy2>0){if($now<=$dummy2 && $then>$dummy2){$btip=true;}}
          if($btip==true){
            $spiel0=substr($dum[1],2);
            $mterm0=$dum[2];
            if($lmtype0==0){$modus0=1;}
            if(!isset($mspez0)){$mspez0="";}
            if(!isset($msieg0)){$msieg0=0;}
            ...
            if($favteam==$teama0){$teama0="<b>".$teams[$teama0]."</b>";}else{$teama0=$teams[$teama0];}
            array_push($teama, $teama0);
            if($favteam==$teamb0){$teamb0="<b>".$teams[$teamb0]."</b>";}else{$teamb0=$teams[$teamb0];}
            array_push($teamb, $teamb0);
            if($goala0==""){$goala0=-1;}
            if($goala0=="-1"){$goala0="_";}
            if($goala0=="-2"){$msieg0=1;$goala0=0;}
            array_push($goala, $goala0);
            if($goalb0==""){$goalb0=-1;}
            if($goalb0=="-1"){$goalb0="_";}
            if($goalb0=="-2"){$msieg0=2;$goalb0=0;}
            array_push($goalb, $goalb0);
            if($mspez0==0){$mspez0="&nbsp;";}
            if($mspez0==2){$mspez0=$text[0];}
            if($mspez0==1){$mspez0=$text[1];}
            array_push($mspez, $mspez0);
            $mspez0=0;
            if(!isset($mtipp0)){$mtipp0=0;}
            ...
            for($j=1;$j<=count($tippdaten);$j++){
              ...
              elseif($op8=="GB"){
                ...
                if($spieltag0t==$spieltag0 && $spiel0t==$spiel0){
                  if($tippa0==""){$tippa0=-1;}
                  if($tippa0=="-1"){$tippa0="_";}
                  if($tippb0==""){$tippb0=-1;}
                  if($tippb0=="-1"){$tippb0="_";}
                  $tippa[$anzspiele]=$tippa0;
                  $tippb[$anzspiele]=$tippb0;
                  if($jokertipp==1){
                    if($dum1[3]==$spiel0t){$jksp[$anzspiele-1]=$spiel0t;}
                    else{$jksp[$anzspiele-1]=0;}
