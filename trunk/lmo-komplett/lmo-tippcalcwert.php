...
if(!file_exists($auswertfile))
  ...
  if($showstsiege==1){$stsiege = array_pad($array,$anztipper+1,"");}
  ...
  if($showstsiege==1 && $anztipper>0){ // Spieltagssieger ermitteln
  ...
  for($a=0;$a<$anztipper;$a++){
    ...
    for($k=1;$k<=3;$k++){
      if($k==1){$krit=$krit1;}elseif($k==2){$krit=$krit2;}elseif($k==3){$krit=$krit3;}
      if($krit==0){$tt.=(50000000+$quotegesamt[$a]);}
      elseif($krit==1){$tt.=(50000000+$spielegetipptgesamt[$a]);}
      elseif($krit==6){if($showstsiege==1){$tt.=(50000000+$stsiege[$a]);}}
      elseif($showzus==1){
        if($krit==2){$tt.=(50000000+$punkte1gesamt[$a]);}
        elseif($krit==3){$tt.=(50000000+$punkte2gesamt[$a]);}
        elseif($krit==4){$tt.=(50000000+$punkte3gesamt[$a]);}
        elseif($krit==5){$tt.=(50000000+$punkte6gesamt[$a]);}
        }
      }
