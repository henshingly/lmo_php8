<table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr><? 
if($st<0 || $todo!="edit"){?>
    <td class="lmost2" align="center"><a href='<?=$addr?>1' onclick="return chklmolink(this.href);" title="<?=$text[411]?>"><?=$text[412]?></a></td><?
}else{?>
    <td class="lmost1" align="center"><?=$text[412]?></td><?
}
if($st!=-1){?>
    <td class="lmost2" align="center"><a href='<?=$addr?>-1' onclick="return chklmolink(this.href);" title="<?=$text[100]?>"><?=$text[99]?></a></td><?
}else{?>
