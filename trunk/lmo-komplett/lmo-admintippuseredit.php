...
?>
  ...
  <tr><td align="center" class="lmost1"><?PHP echo $text[606]; ?></td></tr>
  ...
  <input type="hidden" name="newpage" value="1">
    ...
    <tr>
      ...
      <td class="lmost5"><input type="checkbox" name="xfrei" value="1" <?PHP if($dummb[2]==5){echo "checked";} ?>><?PHP echo $text[647] ?></td>
    </tr>
    <tr>
...
<?PHP if($tipperimteam>=0){ ?>
    ...
    <tr>
      <td class="lmost5" width="20">&nbsp;</td>
      <td class="lmost5" colspan="2"><input type="radio" name="xtippervereinradio" value="0" id="0" <?PHP if($xtippervereinradio==0){echo "checked";} ?>><label for="0"><?PHP echo $text[550]; ?></label></td>
    </tr>
    <tr>
      <td class="lmost5" width="20">&nbsp;</td>
      <td class="lmost5"><input type="radio" name="xtippervereinradio" value="1" id="1" <?PHP if($xtippervereinradio==1){echo "checked";} ?>><label for="1"><?PHP echo $text[548]; ?></label></td>
    ...
    <tr>
      <td class="lmost5" width="20">&nbsp;</td>
      <td class="lmost5"><input type="radio" name="xtippervereinradio" value="2" id="2" <?PHP if($xtippervereinradio==2){echo "checked";} ?>><label for="2"><?PHP echo $text[549]; ?></label></td>
