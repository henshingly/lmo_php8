...
require("init.php");
@include(PATH_TO_TEMPLATEDIR."/style-nc.css");
echo <<<STYLE
a span.popup {
	display: none;
}
...
TD {}
  ...
  .lmost5 { line-height:125%; background: $tabcback; color: $tabccolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: normal; }
  ...
  .lmocross1 { background: $tabbback; color: $tabbcolo; font-family: $tabcfont; font-size: $tabdsize; font-weight: bold; }
  .lmocross2 { background: $tabbback; color: $tabccolo; font-family: $tabcfont; font-size: $tabdsize; font-weight: normal; }
  ...
  .lmocross4 { background: $tabcgrey; color: $tabccolo; font-family: $tabcfont; font-size: $tabdsize; font-weight: bold; }
  .lmocross5 { background: $tabcback; color: $tabccolo; font-family: $tabcfont; font-size: $tabdsize; font-weight: normal; }
  ...
  .lmocross6 { background: $tabftur1; color: $tabccolo; font-family: $tabcfont; font-size: $tabdsize; font-weight: normal; }
