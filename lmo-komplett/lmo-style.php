...
TABLE { padding: 0; margin: 0; }
  ...
  .lmosta { background: $tabbback; border: $tabbbord; }
  .lmostb {  background: $tabcback; border: $tabcbord; }
TD {}
  .lmomain0 { padding: 2px; background: $tababack; color: $tabacoti; font-family: $tabafont; font-size: $tabatite; font-weight: bold; }
  .lmomain1 { padding: 2px; background: $tababack; color: $tabacolo; font-family: $tabafont; font-size: $tabasize; font-weight: bold; }
  ...
  .lmost0 { padding: 2px; background: $tabbback; color: $tabccolo; font-family: $tabbfont; font-size: $tabbsize; font-weight: normal; }
  ...
  .lmost0a { padding: 2px; background: $tabbback; color: $tabbcolo; font-family: $tabbfont; font-size: $tabbsize; font-weight: bold; }
  ...
  .lmost2 { padding: 2px; background: $tabbback; color: $tabbcolo; font-family: $tabbfont; font-size: $tabbsize; font-weight: normal; }
  ...
  .lmost3 { padding: 2px; background: $tabbback; }
  .lmost4 { padding: 2px; background: $tabcgrey; color: $tabccolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: bold; }
  ...
  .lmost5 { padding: 2px; line-height:125%; background: $tabcback; color: $tabccolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: normal; }
  ...
  .lmost7 { padding: 2px; background: $tabftur1; color: $tabccolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: normal; }
  ...
  .lmost9a { padding: 2px; background: $tabftur2; color: $tabccolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: normal; }
  ...
  .lmost9b { padding: 2px; background: $tabftur3; color: $tabccolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: normal; }
  ...
  .lmost9c { padding: 2px; background: $tabftur4; color: $tabccolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: normal; }
  ...
  .lmotab1 { padding: 2px; background: $tabftab1; color: $tabccolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: normal; }
  ...
  .lmotab2 { padding: 2px; background: $tabftab2; color: $tabccolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: normal; }
  ...
  .lmotab3 { padding: 2px; background: $tabftab3; color: $tabccolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: normal; }
  ...
  .lmotab4 { padding: 2px; background: $tabftab4; color: $tabccolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: normal; }
  ...
  .lmotab5 { padding: 2px; background: $tabftab6; color: $tabccolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: normal; }
  ...
  .lmotab8 { padding: 2px; background: $tabftab5; color: $tabccolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: normal; }
  ...
  .lmocross1 { padding: 2px; background: $tabbback; color: $tabbcolo; font-family: $tabcfont; font-size: 75%; font-weight: bold; }
  .lmocross2 { padding: 2px; background: $tabbback; color: $tabccolo; font-family: $tabcfont; font-size: 75%; font-weight: normal; }
  ...
  .lmocross4 { padding: 2px; background: $tabcgrey; color: $tabccolo; font-family: $tabcfont; font-size: 75%; font-weight: bold; }
  .lmocross5 { padding: 2px; background: $tabcback; color: $tabccolo; font-family: $tabcfont; font-size: 75%; font-weight: normal; }
  ...
  .lmocross6 { padding: 2px; background: $tabftur1; color: $tabccolo; font-family: $tabcfont; font-size: 75%; font-weight: normal; }
  ...
  .lmocalat { border: 1px solid $tabcgrey; padding: 2px; background: $tabcback; color: $tabccolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: bold; }
  ...
  .lmocalht { border: 1px solid $tabcgrey; padding: 2px; background: $tabhback; color: $tabccolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: bold; }
  ...
  .lmocalwe { border: 1px solid $tabcgrey; padding: 2px; background: $tabcback; color: $tabwcolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: bold; }
  ...
  .lmocalhe { border: 1px solid $tabcgrey; padding: 2px; background: $tabhback; color: $tabwcolo; font-family: $tabcfont; font-size: $tabcsize; font-weight: bold; }
