...
if ($show==0) {?>          
          ...
          <tr>
            ...
            <td class="lmost5" colspan="4"><input class="lmo-formular-input" type="text" name="xdirliga" size="20" maxlength="80" value="<?=$dirliga;?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" align="right"><acronym title="<?=$text[240]?>"><?=$text[239];?></acronym></td>
            <td class="lmost5" colspan="4"><input class="lmo-formular-input" type="text" name="xdeftime" size="5" maxlength="5" value="<?=$deftime;?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" align="right"><acronym title="<?=$text[344]?>"><?=$text[343];?></acronym></td>
            <td class="lmost5" colspan="4"><input class="lmo-formular-input" type="text" name="xadr" size="40" maxlength="128" value="<?=$aadr;?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="lmost5"><input type="checkbox" class="lmo-formular-input" name="xbacklink" onChange="dolmoedit()"<?if($backlink==1){echo " checked";}?>></td>
            <td class="lmost5" width="15%">&nbsp;</td>
            <td class="lmost5" align="right"><input type="checkbox" class="lmo-formular-input" name="xarchivlink" onChange="dolmoedit()"<?if($archivlink==1){echo " checked";}?>></td>
          ...
          <tr>
            ...
            <td class="lmost5"><input type="checkbox" class="lmo-formular-input" name="xcalctime" onChange="dolmoedit()"<?if($calctime==1){echo " checked";}?>></td>
            <td class="lmost5">&nbsp;</td>
            <td class="lmost5" align="right"><input type="checkbox" class="lmo-formular-input" name="xeinsavehtml" onChange="dolmoedit()"<?if($einsavehtml==1){echo " checked";}?>></td>
          ...
          <tr>
            ...
            <td class="lmost5"><input type="checkbox" class="lmo-formular-input" name="xeinhinrueck" onChange="dolmoedit()"<?if($einhinrueck==1){echo " checked";}?>></td>
            <td class="lmost5">&nbsp;</td>
            <td class="lmost5" align="right"><input type="checkbox" class="lmo-formular-input" name="xeinzustats" onChange="dolmoedit()"<?if($einzustats==1){echo " checked";}?>></td>
          ...
          <tr>
            ...
            <td class="lmost5"><input type="checkbox" class="lmo-formular-input" name="xeinspieler" onChange="dolmoedit()"<?if($einspieler==1){echo " checked";}?>></td>
            <td class="lmost5">&nbsp;</td>
            <td class="lmost5" align="right"><input type="checkbox" class="lmo-formular-input" name="xeintippspiel" onChange="dolmoedit()"<?if($eintippspiel==1){echo " checked";}?>></td>
          ...
          <tr>
            ...
            <td class="lmost5"><input type="checkbox" class="lmo-formular-input" name="xeinspielfrei" onChange="dolmoedit()"<?if($einspielfrei==1){echo " checked";}?>></td>
            <td class="lmost5" colspan="3">&nbsp;</td>
          </tr>
          <tr>
            <td class="lmost5" rowspan="2" align="right"><acronym title="<?=$text[490]?>"><?=$text[489];?></acronym></td>
            <td class="lmost5" colspan="4"><input type="checkbox" class="lmo-formular-input" name="xeinzutoretab" onChange="dolmoedit()"<?if($einzutoretab==1){echo " checked";}?>>&nbsp;<?=$text[491]?>
          </tr>
          <tr>
            <td class="lmost5" colspan="4">
