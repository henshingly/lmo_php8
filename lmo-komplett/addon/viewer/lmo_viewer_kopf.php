...
if (isset($_GET['multi']) && strpos($_GET['multi'],"/")===FALSE) {
	require($_GET['multi']);
}else{
	require(PATH_TO_ADDONDIR."/viewer/std.multi.inc.php");
}

$akt_date_ts=time();
$date_anfang_ts=$akt_date_ts-(24*60*60*$viewer_tage_minus);    // Anzeige ab wann?
$date_ende_ts=$akt_date_ts+(60*60*24*$viewer_tage_plus);       // Anzeige bis wann?
echo $design;
?>
