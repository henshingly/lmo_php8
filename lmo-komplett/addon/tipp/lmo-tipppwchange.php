...
<?PHP if($newpage!=1){ ?>
  ...
  <input type="hidden" name="newpage" value="1">
    <tr>
      ...
      <td class="lmost5" align="right"><acronym><?PHP echo " ".$text['tipp'][140]; ?></acronym></td>
    ...
    <tr>
      <td class="lmost5" width="20">&nbsp;</td>
      <td class="lmost5" align="right"><acronym><?PHP echo " ".$text['tipp'][139]; ?></acronym></td>
    ...
    <tr>
      <td class="lmost5" width="20">&nbsp;</td>
      <td class="lmost5" align="right"><acronym><?PHP echo " ".$text['tipp'][139]." ".$text['tipp'][19]; ?></acronym></td>
