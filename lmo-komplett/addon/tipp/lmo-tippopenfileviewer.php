      ...
      if($op2=="Round"){
        ...
        if($dum[1]=="D1"){
          ...
          if($dum[2]!=""){
            ...
            if($tipp_tippohne==1 && $deftime>0){$dummy1=$dummy1+substr($deftime,0,2)*60*60+substr($deftime,3,2)*60;}
        ...
        elseif($dum[1]=="D2"){
          ...
          if($dum[2]!=""){
            ...
            if($tipp_tippohne==1 && $deftime>0){$dummy2=$dummy2+substr($deftime,0,2)*60*60+substr($deftime,3,2)*60;}
