  ...
  for($i=1;$i<=count($tippdaten);$i++){
    ...
    if($op4=="GA"){
      if($lmtype!=0){
        ...
        if($dum[2]>0){$toregesa[$op6][$op7]+=$dum[2];}
        }
      else{
        $tippa[$t][$op3]=$dum[2];
        if($dum[2]>0){$toregesa[$op3]+=$dum[2];}
        }
      }
    if($op4=="GB"){
      if($lmtype!=0){
        $tippb[$t][$op6][$op7]=$dum[2];
        if($dum[2]>=0){$toregesb[$op6][$op7]+=$dum[2];$anzgetippt[$op6][$op7]++;}
        
        if($tippb[$t][$op6][$op7]<$tippa[$t][$op6][$op7]){$tendenz1[$op6][$op7]++;}
        elseif($tippb[$t][$op6][$op7]>$tippa[$t][$op6][$op7]){$tendenz2[$op6][$op7]++;}
        elseif($tippa[$t][$op6][$op7]>=0 && $tippb[$t][$op6][$op7]>=0){$tendenz0[$op6][$op7]++;}
        }
      else{
        $tippb[$t][$op3]=$dum[2];
        if($dum[2]>=0){$toregesb[$op3]+=$dum[2];$anzgetippt[$op3]++;}
        
        if($tippb[$t][$op3]<$tippa[$t][$op3]){$tendenz1[$op3]++;}
        elseif($tippb[$t][$op3]>$tippa[$t][$op3]){$tendenz2[$op3]++;}
        elseif($tippa[$t][$op3]>=0 && $tippb[$t][$op3]>=0){$tendenz0[$op3]++;}
        }
      }
    }
