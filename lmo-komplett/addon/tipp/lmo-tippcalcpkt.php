...
function tipppunkte($gta0, $gtb0, $ga0, $gb0, $msieg, $msp, $text0, $text1, $jkspfaktor0, $mtipp){// wieviel Punkte gibts für den Tipp
  ...
  elseif($tipp_tippmodus==1){ // Ergebnis-Tippmodus
    if($msieg==0){
      ...
      elseif($gta0==$ga0 && $gtb0==$gb0){
      	...
      	if($tipp_showzus==1){$punkte1++;}
      	}
      elseif($ga0==$gb0 && $gta0==$gtb0 && $tipp_rtendenzremis==1){ // richtiger 0-Tipp
      	$punktespiel=$tipp_rtendenz;
      	if($tipp_showzus==1){$punkte3++;}
      	}
    ...
    elseif($tipp_gtpunkte==2 && ($msieg==1 || $msieg==2 || $msieg==3)){ // GT-Entscheidung nicht werten
      $punktespiel=-1;
      }
  ...
  elseif($tipp_tippmodus==0){ // Tendenz-Tippmodus
    if($msieg==0){
      if($msp==$text0 && $tipp_entscheidungnv==1){ if($gtb0==$gta0){$punktespiel=1;}else{$punktespiel=0;} }
      elseif($msp==$text1 && $tipp_entscheidungie==1){ if($gtb0==$gta0){$punktespiel=1;}else{$punktespiel=0;} }
  ...
  if($tipp_rremis>0 && $punktespiel>0 && $gtb0==$gta0  && $gb0==$ga0){
    ...
    if($tipp_showzus==1){$punkte5++;}
    }
  if($jkspfaktor0>1 && $punktespiel>0){
    if($tipp_showzus==1){$punkte6+=$punktespiel*$jkspfaktor0-$punktespiel;}
