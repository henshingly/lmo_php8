...
<?PHP if($newpage!=1){ ?>
  ...
  <input type="hidden" name="newpage" value="1">
    <tr>
      ...
      <td class="lmost5" align="right"><acronym><?PHP echo " ".$text['tipp'][69]; ?></acronym></td>
...
<?PHP if($newpage==1){ // erfolgreich ?>
   ...
   <tr>
      <td class="lmost4" align="right"><a href="<?PHP echo $_SERVER['PHP_SELF']."?action=tipp&amp"; ?>">=> <?PHP echo $text['tipp'][141]; ?></a></td>
   </tr>
<?PHP } ?>
