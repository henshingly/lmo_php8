      ...
      <form name="lmoedit" action="<?=$_SERVER['PHP_SELF']?>" method="post" onSubmit="return chklmopass()">
        ...
        <table class="lmostb" cellspacing="0" cellpadding="0" border="0">
          ...
          <tr>
            ...
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabafont" size="25" maxlength="50" value="<?=$stylearr["TD.lmomain1"]["font-family"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
          ...
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[425] ?>"><?=$text[424]?></acronym>,&nbsp;<acronym title="<?=$text[433] ?>"><?=$text[442]?></acronym></td>
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabbback" size="7" maxlength="7" value="<?=$stylearr["TABLE.lmosta"]["background"]?>" onChange="dolmoedit()">&nbsp;<input class="lmoadminein" type="text" name="xtabbcolo" size="7" maxlength="7" value="<?=$stylearr["TD.lmost1"]["color"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[427] ?>"><?=$text[426]?></acronym></td>
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabbbord" size="25" maxlength="25" value="<?=$stylearr["TABLE.lmosta"]["border"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[429] ?>"><?=$text[428]?></acronym></td>
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabbfont" size="25" maxlength="50" value="<?=$stylearr["TD.lmost1"]["font-family"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
          ...
          <tr>
            ...
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabcback" size="7" maxlength="7" value="<?=$stylearr["TABLE.lmostb"]["background"]?>" onChange="dolmoedit()">&nbsp;<input class="lmoadminein" type="text" name="xtabcgrey" size="7" maxlength="7" value="<?=$stylearr["TD.lmost4"]["background"]?>" onChange="dolmoedit()">&nbsp;<input class="lmoadminein" type="text" name="xtabccolo" size="7" maxlength="7" value="<?=$stylearr["TD.lmost5"]["color"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[427] ?>"><?=$text[426]?></acronym></td>
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabcbord" size="25" maxlength="25" value="<?=$stylearr["TABLE.lmostb"]["border"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[429] ?>"><?=$text[428]?></acronym></td>
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabcfont" size="25" maxlength="50" value="<?=$stylearr["TD.lmost5"]["font-family"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[438] ?>"><?=$text[437]?></acronym></td>
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabcsize" size="6" maxlength="6" value="<?=$stylearr["TD.lmost5"]["font-size"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
          ...
          <tr>
            ...
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabftab1" size="7" maxlength="7" value="<?=$stylearr["TD.lmotab1"]["background"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[425] ?>"><?=$text[452]?></acronym></td>
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabftab2" size="7" maxlength="7" value="<?=$stylearr["TD.lmotab2"]["background"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[425] ?>"><?=$text[453]?></acronym></td>
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabftab3" size="7" maxlength="7" value="<?=$stylearr["TD.lmotab3"]["background"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[425] ?>"><?=$text[454]?></acronym></td>
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabftab4" size="7" maxlength="7" value="<?=$stylearr["TD.lmotab4"]["background"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[425] ?>"><?=$text[455]?></acronym></td>
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabftab5" size="7" maxlength="7" value="<?=$stylearr["TD.lmotab8"]["background"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[425] ?>"><?=$text[456]?></acronym></td>
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabftab6" size="7" maxlength="7" value="<?=$stylearr["TD.lmotab5"]["background"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[425] ?>"><?=$text[457]?></acronym></td>
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabftab7" size="7" maxlength="7" value="<?=$stylearr["TD.lmotab6"]["background"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
          ...
          <tr>
            ...
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabftur1" size="7" maxlength="7" value="<?=$stylearr["TD.lmost7"]["background"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[425] ?>"><?=$text[461]?></acronym></td>
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabftur2" size="7" maxlength="7" value="<?=$stylearr["TD.lmost9a"]["background"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[425] ?>"><?=$text[462]?></acronym></td>
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabftur3" size="7" maxlength="7" value="<?=$stylearr["TD.lmost9b"]["background"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
          ...
          <tr>
            ...
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabhback" size="7" maxlength="7" value="<?=$stylearr["TD.lmocalht"]["background"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
          ...
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[425] ?>"><?=$text[424]?></acronym>,&nbsp;<acronym title="<?=$text[433] ?>"><?=$text[442]?></acronym></td>
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabtback" size="7" maxlength="7" value="<?=$stylearr["INPUT.lmotickerein"]["background"]?>" onChange="dolmoedit()">&nbsp;<input class="lmoadminein" type="text" name="xtabtcolo" size="7" maxlength="7" value="<?=$stylearr["INPUT.lmotickerein"]["color"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[429] ?>"><?=$text[428]?></acronym></td>
            <td class="lmost5"><input class="lmoadminein" type="text" name="xtabtfont" size="25" maxlength="50" value="<?=$stylearr["INPUT.lmotickerein"]["font-family"]?>" onChange="dolmoedit()"></td>
          </tr>
          <tr>
            <td class="lmost5" width="20">&nbsp;</td>
            <td class="lmost5" align="right"><acronym title="<?=$text[438] ?>"><?=$text[437]?></acronym></td>
